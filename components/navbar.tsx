    ...
    >
      <div className="h-full px-3 py-4 overflow-y-auto">
        ...
        <li>
            ...
            >
              <Image src="/DASK.png" alt="Logo" width={40*2} height={50*2} class="ml-0"/>
            </div>
          </li>
          <li>
            <Link
              href="/home"
              className="flex items-center mt-6 p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Задания</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ms-3 flex items-center whitespace-nowrap">Уведомления <span className="bg-red-500 rounded-full h-6 ml-2 flex justify-center w-6 text-white">9+</span></span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Профиль</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Мероприятия</span>
            </Link>
          </li>
        </ul>
      </div>
